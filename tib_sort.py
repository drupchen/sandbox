...
with open('/home/drupchen/PycharmProjects/sandbox/Classes/PyTib/data/uncompound_lexicon.txt', 'r', -1, 'utf-8-sig') as f:
    content = [line.strip() for line in f.readlines()]

with open('/home/drupchen/PycharmProjects/sandbox/Classes/PyTib/data/uncompound_lexicon.txt', 'w', -1, 'utf-8-sig') as f:
    f.write('\n'.join(tib_sort(content)))